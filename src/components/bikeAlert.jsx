      ...
      <div className='container'>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-xs-12 col-md-6">
              <div className="about-text" style={{paddingBottom: '50px'}}>
        ...
        <div className="container">
          <div className="row">
            <div className="col-xs-12 col-md-6 ">
              <iframe id='video-responsive' src="https://www.youtube.com/embed/feM65He3v98" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            <div className="col-xs-12 col-md-6">
              <div className="about-text" style={{paddingBottom: '50px'}}>
                <h2>{t("bikeAlert.how")}</h2>
